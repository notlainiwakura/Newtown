...
const SERVER_ENDPOINTS: Endpoint[] = [
  ...
  { path: '/api/town-events',               method: 'GET',    auth: 'none',                server: 'server', description: 'read town events',                responseType: 'json' },
  { path: '/api/town-events/effects',       method: 'GET',    auth: 'none',                server: 'server', description: 'merged event effects',            responseType: 'json' },
...
const CONTENT_TYPE_CASES: [string, HttpMethod, string, ServerSource, string][] = [
  ...
  ['/api/town-events',        'GET',  'none',       'server',           'application/json'],
